...
// Include required classes using absolute paths
require_once CLASSES_PATH . 'Database.php';
require_once CLASSES_PATH . 'User.php';
require_once CLASSES_PATH . 'Product.php';
require_once CLASSES_PATH . 'Sale.php';
require_once CLASSES_PATH . 'Purchase.php';
require_once CLASSES_PATH . 'Receipt.php';
require_once CLASSES_PATH . 'Attendance.php';

...
if (isset($_GET['ajax'])) {
    ...
    if ($_GET['ajax'] === 'toggle_status' && isset($_GET['id'])) {
        $staff = $user->getUserById($_GET['id']);
        if ($staff) {
            if ($staff['is_active']) {
                $result = $user->deactivateUser($_GET['id']);
            } else {
                $result = $user->activateUser($_GET['id']);
            }
        ...
        <main class="p-8">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <div class="flex space-x-3">
                    <a href="attendance.php" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-medium">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-gray-500"><?php echo $staff['email'] ?? 'No email'; ?></div>
                                </td>
                                <td class="px-6 py-4 font-mono text-gray-600"><?php echo $staff['username']; ?></td>
                                <td class="px-6 py-4">
                                    <span class="px-2 py-1 text-xs bg-blue-100 text-blue-800 rounded-full">
                                        <?php echo User::getRoleName($staff['role']); ?>
                                    </span>
                                </td>
                                <td class="px-6 py-4 font-mono text-gray-600"><?php echo $staff['qid_number'] ?? '-'; ?></td>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="username" required
                                               ...
                                               class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary"
                                               placeholder="Login username" <?php echo $action === 'edit' ? 'readonly' : ''; ?>>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="password" name="password" 
                                                   ...
                                                   class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary pr-12"
                                ...
                                <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    ...
                                    <div class="space-y-4">
                                        <div class="text-center">
                                            <h4 class="font-bold text-xl text-gray-800" id="preview-name"><?php echo $currentStaff['name'] ?? 'Full Name'; ?></h4>
                                            <p class="text-sm text-gray-600" id="preview-role"><?php echo isset($currentStaff['role']) ? User::getRoleName($currentStaff['role']) : 'Role'; ?></p>
                                        </div>
                                        ...
                                        <div class="space-y-3">
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="font-semibold text-gray-800" id="preview-qid"><?php echo $currentStaff['qid_number'] ?? 'Not set'; ?></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="font-semibold text-gray-800 truncate" id="preview-email"><?php echo $currentStaff['email'] ?? 'Not set'; ?></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="font-semibold text-gray-800" id="preview-phone"><?php echo $currentStaff['phone'] ?? 'Not set'; ?></p>
                                                </div>
                                            </div>

...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen overflow-hidden" x-data="posSystem()" @keydown.window="handleKeydown($event)">
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border-b border-blue-200 dark:border-blue-800 px-4 py-1">
        <div class="flex justify-center items-center space-x-6 text-xs text-blue-800 dark:text-blue-200">
            <span><kbd class="bg-blue-200 dark:bg-blue-800 px-1 rounded">F4</kbd> Print Order</span>
            <span><kbd class="bg-blue-200 dark:bg-blue-800 px-1 rounded">F5</kbd> Hold Order</span>
            <span><kbd class="bg-blue-200 dark:bg-blue-800 px-1 rounded">F7</kbd> FOC</span>
            <span><kbd class="bg-blue-200 dark:bg-blue-800 px-1 rounded">F8</kbd> Credit</span>
            <span><kbd class="bg-blue-200 dark:bg-blue-800 px-1 rounded">F9</kbd> Card</span>
            <span><kbd class="bg-blue-200 dark:bg-blue-800 px-1 rounded">F10</kbd> Cash</span>
            <span><kbd class="bg-blue-200 dark:bg-blue-800 px-1 rounded">F11</kbd> Set Qty</span>
            <span><kbd class="bg-blue-200 dark:bg-blue-800 px-1 rounded">+/-</kbd> Qty</span>
            <span><kbd class="bg-blue-200 dark:bg-blue-800 px-1 rounded">Ctrl+T</kbd> Table</span>
        </div>
    </div>

    <div class="flex h-screen" style="height: calc(100vh - 88px);">
        <!-- Categories Sidebar -->
        ...
        function posSystem() {
            return {
                ...
                handleKeydown(event) {
                    ...
                    // Function keys for payment methods
                    if (event.key === 'F7') {

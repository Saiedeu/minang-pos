...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen overflow-hidden" x-data="posSystem()" @keydown.window="handleKeydown($event)">
            ...
            <div class="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
                ...
                <div class="grid grid-cols-2 gap-2 mb-2">
                    <button @click="holdOrder()" :disabled="cart.length === 0"
                        ...
                        <i class="fas fa-hourglass-start mr-1"></i>Hold (F5)
                    </button>
    ...
    <!-- Add Customer Modal -->
    <div x-show="showAddCustomerModal" x-cloak class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white">Add New Customer</h3>
                    <button @click="closeAddCustomerModal()" class="text-gray-500 hover:text-gray-700 dark:text-gray-400">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                ...
                <form @submit.prevent="saveNewCustomer()" class="space-y-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Customer ID</label>
                        <input type="text" x-model="newCustomer.customer_id" 
                               class="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary"
                               placeholder="Auto-generated if empty">
                        <p class="text-xs text-gray-500 mt-1">Format: CUS20240101001</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" x-model="newCustomer.phone" required x-ref="customerPhoneInput"
                               class="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary"
                    ...
                    <div>
                        ...
                        <textarea x-model="newCustomer.address" rows="3"
                                  class="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary resize-none"
                                  placeholder="Complete address for delivery orders"></textarea>
                    </div>
                    ...
                    <div class="flex space-x-3 pt-4">
                        ...
                        <button type="submit" 
                                class="flex-1 p-3 bg-primary hover:bg-blue-600 text-white rounded-lg font-semibold transition-all">
    ...
    <div x-show="showHeldOrdersModal" x-cloak class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div class="p-6">
                ...
                <template x-if="heldOrders.length === 0">
                    <div class="text-center py-8">
                        <i class="fas fa-hourglass-half text-3xl text-gray-300 dark:text-gray-600 mb-3"></i>

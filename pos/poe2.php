<?php
/**
 * POS System - Sales Interface - FIXED VERSION
...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen overflow-hidden" x-data="posSystem()" @keydown.window="handleKeydown($event)">
    ...
    <!-- Enhanced Add-ons Modal with Free Text and Charge Toggle -->
    ...
    <script>
        function posSystem() {
            return {
                ...
                setupBeepSound() {
                    // Create multiple audio instances for better performance
                    this.beepAudio = new Audio('../assets/sounds/beep.mp3');
                    this.beepAudio.volume = 0.5;
                    this.beepAudio.preload = 'auto';
                    
                    // Fallback audio
                    this.beepAudio2 = new Audio('data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvmEaBjyZ2e/HeycFKH3J7+ONQQ0XZLPK6qNSEwpTnOPx7l8YATua2e3FfSgFJXrI7t+LPw0YaLRxwgt');
                    this.beepAudio2.volume = 0.3;
                },

                playBeepSound() {
                    try {
                        // Try primary audio first
                        const audio = this.beepAudio.cloneNode();
                        audio.volume = 0.5;
